...
extern "C" {
	...
	// Shim: const getSensorList -> non-const getSensorList
	ssize_t _ZNK7android13SensorManager13getSensorListEPPKPKNS_6SensorE(void* obj, android::Sensor const* const** list) {
	    return ((android::SensorManager*)obj)->getSensorList(list);
	}
}
}
